...
/**
 * Provides the constants for the standard SIP header names and values and
 * commonly used utility methods that accesses an {@link SipMessage}.
 *
...
public abstract class SipHeaders implements Iterable<Map.Entry<String, String>>  {
    ...
    /**
     * To deal with the sip header compact form
     * <p>
     * eg:
     * The compact form of Content-Length field is l.
     * </p>
     */
    public List<String> getAllWithCompact(CharSequence name, CharSequence compactForm) {
        List<String> al  = getAll(name);
        if(compactForm == null) return al;
        al.addAll(getAll(compactForm));
        return al;
    }
     ...
     * format defined in <a href="https://www.rfc-editor.org/rfc/rfc3261.html#section-20.17">RFC3261</a>.
     *
